...
* <https://github.com/sqlmapproject/sqlmap> ⭐ 38,451 | 🐛 31 | 🌐 Python | 📅 2026-09-15 - Automatic SQL injection and database takeover tool

* <https://github.com/trustedsec/social-engineer-toolkit> ⭐ 15,302 | 🐛 14 | 🌐 Python | 📅 2026-06-04 - The Social-Engineer Toolkit (SET) repository from TrustedSec

* <https://github.com/owasp-amass/amass> ⭐ 15,164 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - domain recon

* <https://github.com/future-architect/vuls> ⭐ 12,256 | 🐛 91 | 🌐 Go | 📅 2026-09-14 Vulnerability scanner for Linux, agentless, written in golang.

* <https://github.com/beefproject/beef> ⭐ 11,019 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-14 - The Browser Exploitation Framework Project

* <https://github.com/sullo/nikto> ⭐ 10,728 | 🐛 1 | 🌐 Perl | 📅 2026-09-15 - Nikto web server scanner

* <https://github.com/wpscanteam/wpscan> ⭐ 9,767 | 🐛 1 | 🌐 Ruby | 📅 2026-09-14 - WPScan is a black box WordPress vulnerability scanner

* <https://github.com/urbanadventurer/WhatWeb> ⭐ 6,838 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 WhatWeb - Next generation web scanner

* <https://github.com/commixproject/commix> ⭐ 5,845 | 🐛 4 | 🌐 Python | 📅 2026-09-15 Automated All-in-One OS command injection and exploitation tool

* <https://github.com/assetnote/kiterunner> ⭐ 3,262 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API discovery

* <https://github.com/joaomatosf/jexboss> ⭐ 2,521 | 🐛 28 | 🌐 Python | 📅 2020-01-21 JBoss (and others Java Deserialization Vulnerabilities) verify and EXploitation Tool
...
* <https://github.com/owtf/owtf> ⭐ 1,953 | 🐛 74 | 🌐 Python | 📅 2026-09-05 Offensive Web Testing Framework (OWTF)

* <https://github.com/iSECPartners/Scout2> ⚠️ Archived - Security auditing tool for AWS environments

* <https://github.com/vigolium/vigolium> ⭐ 1,071 | 🐛 5 | 🌐 Go | 📅 2026-09-14 - High-fidelity web & API vulnerability scanner fusing agentic AI with a fast native engine; 250+ detection modules covering the OWASP Top 10, authenticated IDOR/BOLA & out-of-band testing, and OpenAPI/Postman/Burp/cURL inputs. Open-source, AGPL-3.0.
...
* <https://github.com/ASCIT31/Dark-Moon> ⭐ 940 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Darkmoon is an open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and keeps a per-finding evidence trail.

* <https://github.com/BlessedRebuS/Krawl> ⭐ 739 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Cloud-native Web deception server and anti-crawler.

* <https://github.com/momenbasel/keyFinder> ⭐ 716 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively scans web pages for leaked API keys, tokens, and secrets using 80+ detection patterns and Shannon entropy across 10 attack surfaces.
...
* <https://github.com/BugTraceAI/BugTraceAI> ⭐ 307 | 🐛 2 | 📅 2026-09-14 - BugTraceAI is an open-source multi-agent platform for authorized web application security testing with validation, evidence capture, and reporting.
...
* <https://github.com/DenisPodgurskii/pentestkit> ⭐ 238 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 - Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* <https://www.deepinfo.com/> - Deepinfo Attack Surface Platform discovers all your digital assets, monitors them 24/7, detects any issues, and notifies you quickly so you can take immediate action.
  * <https://github.com/bountyyfi/lonkero> ⭐ 1,096 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
* `docker pull rustscan/rustscan:2.0.0` - [The Modern Port Scanner](https://github.com/RustScan/RustScan) ⭐ 20,415 | 🐛 62 | 🌐 Rust | 📅 2026-09-09
* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,771 | 🐛 863 | 🌐 Java | 📅 2026-09-15
* `docker pull aaaguirre/pentest` - [Docker for pentest](https://github.com/aaaguirrep/pentest) ⭐ 772 | 🐛 3 | 🌐 Dockerfile | 📅 2022-03-11
...
* <https://github.com/Audi-1/sqli-labs> ⭐ 5,842 | 🐛 33 | 🌐 PHP | 📅 2023-12-11 - SQLI labs to test error based, Blind boolean based, Time based.
* <https://github.com/RhinoSecurityLabs/cloudgoat> ⭐ 3,729 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool
...
* <https://github.com/momenbasel/htb-writeups> ⭐ 247 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - HTB Writeups: The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets.
* <https://github.com/oliverwiegers/pentest_lab> ⭐ 221 | 🐛 0 | 🌐 Shell | 📅 2025-06-17 - Local pentest lab leveraging docker compose.
* <https://github.com/kOaDT/oss-oopssec-store> ⭐ 44 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13 - OSS – OopsSec Store: An intentionally vulnerable e-commerce application built with Next.js and React for web security training and CTF practice.
...
* <https://github.com/rubysec/bundler-audit> ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-09-12 - Patch-level verification for Bundler
* <https://github.com/rubysec/ruby-advisory-db> ⭐ 1,072 | 🐛 3 | 🌐 Ruby | 📅 2026-09-13 - A database of vulnerable Ruby Gems
