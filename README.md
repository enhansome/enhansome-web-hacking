...
* <https://github.com/sqlmapproject/sqlmap> ⭐ 38,319 | 🐛 34 | 🌐 Python | 📅 2026-08-28 - Automatic SQL injection and database takeover tool

* <https://github.com/trustedsec/social-engineer-toolkit> ⭐ 15,243 | 🐛 12 | 🌐 Python | 📅 2026-06-04 - The Social-Engineer Toolkit (SET) repository from TrustedSec

* <https://github.com/owasp-amass/amass> ⭐ 15,073 | 🐛 239 | 🌐 Go | 📅 2026-07-19 - domain recon

* <https://github.com/future-architect/vuls> ⭐ 12,247 | 🐛 88 | 🌐 Go | 📅 2026-08-31 Vulnerability scanner for Linux, agentless, written in golang.

* <https://github.com/beefproject/beef> ⭐ 10,992 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-28 - The Browser Exploitation Framework Project

* <https://github.com/sullo/nikto> ⭐ 10,692 | 🐛 1 | 🌐 Perl | 📅 2026-08-28 - Nikto web server scanner

* <https://github.com/wpscanteam/wpscan> ⭐ 9,745 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a black box WordPress vulnerability scanner

* <https://github.com/urbanadventurer/WhatWeb> ⭐ 6,802 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 WhatWeb - Next generation web scanner

* <https://github.com/commixproject/commix> ⭐ 5,831 | 🐛 4 | 🌐 Python | 📅 2026-08-25 Automated All-in-One OS command injection and exploitation tool

* <https://github.com/assetnote/kiterunner> ⭐ 3,247 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API discovery
...
* <https://github.com/owtf/owtf> ⭐ 1,951 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-22 Offensive Web Testing Framework (OWTF)
...
* <https://github.com/ASCIT31/Dark-Moon> ⭐ 878 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Darkmoon is an open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and keeps a per-finding evidence trail.

* <https://github.com/momenbasel/keyFinder> ⭐ 704 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively scans web pages for leaked API keys, tokens, and secrets using 80+ detection patterns and Shannon entropy across 10 attack surfaces.

* <https://github.com/lalithr95/fuzzapi> ⚠️ Archived Fuzzapi is a tool used for REST API pentesting

* <https://github.com/BlessedRebuS/Krawl> ⭐ 643 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - Cloud-native Web deception server and anti-crawler.
...
* [BadUSB Script To Exfiltrate Passwords](https://github.com/MarkCyber/BadUSB/blob/main/HackStuff/CredentialHarvester.txt) ⭐ 370 | 🐛 2 | 🌐 Python | 📅 2025-03-20 - Extracts all saved passwords from Chrome, Firefox, and Edge to be saved onto secondary USB for further analysis.
...
* <https://www.deepinfo.com/> - Deepinfo Attack Surface Platform discovers all your digital assets, monitors them 24/7, detects any issues, and notifies you quickly so you can take immediate action.
  * <https://github.com/bountyyfi/lonkero> ⭐ 1,049 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
* `docker pull rustscan/rustscan:2.0.0` - [The Modern Port Scanner](https://github.com/RustScan/RustScan) ⭐ 20,343 | 🐛 61 | 🌐 Rust | 📅 2026-08-26
* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,710 | 🐛 858 | 🌐 Java | 📅 2026-08-27
...
* <https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application> ⭐ 1,706 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-24
...
* <https://github.com/momenbasel/htb-writeups> ⭐ 232 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - HTB Writeups: The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets.
* <https://github.com/oliverwiegers/pentest_lab> ⭐ 220 | 🐛 0 | 🌐 Shell | 📅 2025-06-17 - Local pentest lab leveraging docker compose.
* <https://github.com/kOaDT/oss-oopssec-store> ⭐ 42 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-25 - OSS – OopsSec Store: An intentionally vulnerable e-commerce application built with Next.js and React for web security training and CTF practice.
...
* <https://github.com/rubysec/ruby-advisory-db> ⭐ 1,070 | 🐛 3 | 🌐 Ruby | 📅 2026-08-29 - A database of vulnerable Ruby Gems
