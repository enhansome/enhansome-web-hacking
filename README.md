# awesome-web-hacking with stars
...
* <https://github.com/sqlmapproject/sqlmap> ⭐ 38,170 | 🐛 32 | 🌐 Python | 📅 2026-08-11 - Automatic SQL injection and database takeover tool

* <https://github.com/trustedsec/social-engineer-toolkit> ⭐ 15,183 | 🐛 12 | 🌐 Python | 📅 2026-06-04 - The Social-Engineer Toolkit (SET) repository from TrustedSec

* <https://github.com/owasp-amass/amass> ⭐ 14,974 | 🐛 235 | 🌐 Go | 📅 2026-07-19 - domain recon

* <https://github.com/future-architect/vuls> ⭐ 12,235 | 🐛 90 | 🌐 Go | 📅 2026-08-12 Vulnerability scanner for Linux, agentless, written in golang.

* <https://github.com/beefproject/beef> ⭐ 10,976 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-11 - The Browser Exploitation Framework Project

* <https://github.com/sullo/nikto> ⭐ 10,645 | 🐛 1 | 🌐 Perl | 📅 2026-07-31 - Nikto web server scanner

* <https://github.com/wpscanteam/wpscan> ⭐ 9,732 | 🐛 0 | 🌐 Ruby | 📅 2026-07-23 - WPScan is a black box WordPress vulnerability scanner

* <https://github.com/urbanadventurer/WhatWeb> ⭐ 6,778 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 WhatWeb - Next generation web scanner

* <https://github.com/commixproject/commix> ⭐ 5,813 | 🐛 8 | 🌐 Python | 📅 2026-08-13 Automated All-in-One OS command injection and exploitation tool

* <https://github.com/assetnote/kiterunner> ⭐ 3,239 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API discovery

* <https://github.com/joaomatosf/jexboss> ⭐ 2,521 | 🐛 27 | 🌐 Python | 📅 2020-01-21 JBoss (and others Java Deserialization Vulnerabilities) verify and EXploitation Tool

* <https://github.com/nil0x42/phpsploit> ⭐ 2,489 | 🐛 27 | 🌐 Python | 📅 2024-05-06 PhpSploit - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner

* <https://github.com/lukechilds/reverse-shell> ⭐ 2,050 | 🐛 2 | 🌐 Go | 📅 2026-02-18 - Easy to remember reverse shell that should work on most Unix-like systems.

* <https://github.com/owtf/owtf> ⭐ 1,946 | 🐛 113 | 🌐 TypeScript | 📅 2026-08-09 Offensive Web Testing Framework (OWTF)
...
* <https://github.com/vigolium/vigolium> ⭐ 978 | 🐛 4 | 🌐 Go | 📅 2026-08-13 - High-fidelity web & API vulnerability scanner fusing agentic AI with a fast native engine; 250+ detection modules covering the OWASP Top 10, authenticated IDOR/BOLA & out-of-band testing, and OpenAPI/Postman/Burp/cURL inputs. Open-source, AGPL-3.0.

* <https://github.com/ASCIT31/Dark-Moon> ⭐ 833 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - Darkmoon is an open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and keeps a per-finding evidence trail.

* <https://github.com/momenbasel/keyFinder> ⭐ 697 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively scans web pages for leaked API keys, tokens, and secrets using 80+ detection patterns and Shannon entropy across 10 attack surfaces.

* <https://github.com/lalithr95/fuzzapi> ⚠️ Archived Fuzzapi is a tool used for REST API pentesting

* <https://github.com/BlessedRebuS/Krawl> ⭐ 558 | 🐛 9 | 🌐 Python | 📅 2026-08-08 - Cloud-native Web deception server and anti-crawler.

* <https://github.com/RUB-NDS/WS-Attacker> ⭐ 495 | 🐛 19 | 🌐 Java | 📅 2024-10-03 - WS-Attacker is a modular framework for web services penetration testing

* <https://github.com/nccgroup/wssip> ⭐ 450 | 🐛 35 | 🌐 JavaScript | 📅 2022-12-08 Application for capturing, modifying and sending custom WebSocket data from client to server and vice versa.
...
* [BadUSB Script To Exfiltrate Passwords](https://github.com/MarkCyber/BadUSB/blob/main/HackStuff/CredentialHarvester.txt) ⭐ 361 | 🐛 2 | 🌐 Python | 📅 2025-03-20 - Extracts all saved passwords from Chrome, Firefox, and Edge to be saved onto secondary USB for further analysis.

* <https://github.com/tijme/angularjs-csti-scanner> ⭐ 326 | 🐛 2 | 🌐 Python | 📅 2021-10-20 Automated client-side template injection (sandbox escape/bypass) detection for AngularJS (ACSTIS).
...
* <https://github.com/tecknicaltom/dsniff> ⭐ 238 | 🐛 5 | 🌐 C | 📅 2010-06-29 - dsniff is a collection of tools for network auditing and penetration testing.

* <https://github.com/espreto/wpsploit> ⭐ 232 | 🐛 4 | 🌐 Ruby | 📅 2018-04-30 - WPSploit, Exploiting Wordpress With Metasploit

* <https://github.com/DenisPodgurskii/pentestkit> ⭐ 229 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-09 - Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.

* <https://github.com/sensepost/wikto> ⭐ 186 | 🐛 2 | 🌐 C# | 📅 2017-04-20 Wikto - Nikto for Windows with some extra features

* <https://github.com/neuroo/grabber> ⚠️ Archived Grabber

* <https://github.com/GoSecure/csp-auditor> ⭐ 141 | 🐛 4 | 🌐 Java | 📅 2020-04-29 Burp and ZAP plugin to analyze CSP headers

* [Cyclops is a novel browser that can detect vulnerability automatically](https://github.com/v8blink/Chromium-based-XSS-Taint-Tracking/) ⭐ 126 | 🐛 4 | 📅 2024-06-30 - Cyclops is a web browser with XSS detection feature

* <https://github.com/ffleming/timing_attack> ⭐ 123 | 🐛 3 | 🌐 Ruby | 📅 2019-10-13 Perform timing attacks against web applications

* <https://github.com/bad-antics/nullsec-linux> ⭐ 79 | 🐛 2 | 🌐 Shell | 📅 2026-04-17 - NullSec Linux - Security distribution with pre-configured web application testing tools

* <https://github.com/bjeborn/basic-auth-pot> ⭐ 55 | 🐛 0 | 🌐 Python | 📅 2015-01-15 HTTP Basic Authentication honeyPot.

* <https://github.com/flibustier/jwt-online-cracker> ⭐ 20 | 🐛 1 | 🌐 Vue | 📅 2026-04-08 - Brute-force HS256, HS384 or HS512 JWT Token from your browser (fully client-side).

* <https://github.com/bad-antics/nullsec-webfuzz> ⭐ 6 | 🐛 0 | 🌐 Makefile | 📅 2026-04-16 - NullSec WebFuzz - Web application fuzzing framework
...
* <https://github.com/ANVEAI/anve-offsec> ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-04 - Autonomous AI security engineer & bug bounty platform in Kali Linux featuring stateful Hermes reasoning, OpenClaw Chromium browser sidecar, and Qdrant vector strategy RAG. 🇮🇳

* [jwt-auditor](https://github.com/mohelobeid/jwt-auditor) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-07-07 - Offline CLI to decode and audit JWTs for alg:none, weak HMAC secrets, and RS256 to HS256 confusion.
...
* <https://www.deepinfo.com/> - Deepinfo Attack Surface Platform discovers all your digital assets, monitors them 24/7, detects any issues, and notifies you quickly so you can take immediate action.
  * <https://github.com/bountyyfi/lonkero> ⭐ 1,038 | 🐛 12 | 🌐 Rust | 📅 2026-08-12 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
- [ARS3NAL](https://github.com/inflictx/Arsenal) ⭐ 166 | 🐛 4 | 🌐 CSS | 📅 2026-07-09 - Offline-first, searchable arsenal: \~1500 payloads, command generator, GTFOBins, wordlists, embedded CyberChef, reverse shells and 70 checklists.
...
* `docker pull rustscan/rustscan:2.0.0` - [The Modern Port Scanner](https://github.com/RustScan/RustScan) ⭐ 20,260 | 🐛 60 | 🌐 Rust | 📅 2026-07-29
* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,585 | 🐛 854 | 🌐 Java | 📅 2026-08-11
* `docker pull aaaguirre/pentest` - [Docker for pentest](https://github.com/aaaguirrep/pentest) ⭐ 768 | 🐛 2 | 🌐 Dockerfile | 📅 2022-03-11
...
* <https://github.com/Audi-1/sqli-labs> ⭐ 5,826 | 🐛 33 | 🌐 PHP | 📅 2023-12-11 - SQLI labs to test error based, Blind boolean based, Time based.
* <https://github.com/RhinoSecurityLabs/cloudgoat> ⭐ 3,692 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool
* <https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application> ⭐ 1,703 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-24
...
* <https://github.com/paralax/lfi-labs> ⭐ 334 | 🐛 3 | 🌐 PHP | 📅 2024-04-08 - small set of PHP scripts to practice exploiting LFI, RFI and CMD injection vulns
* <https://github.com/jerryhoff/WebGoat.NET> ⭐ 257 | 🐛 16 | 🌐 C# | 📅 2023-12-16 - This web application is a learning platform about common web security flaws.
* <https://github.com/oliverwiegers/pentest_lab> ⭐ 218 | 🐛 0 | 🌐 Shell | 📅 2025-06-17 - Local pentest lab leveraging docker compose.
* <https://github.com/momenbasel/htb-writeups> ⭐ 203 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - HTB Writeups: The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets.
* <https://github.com/kOaDT/oss-oopssec-store> ⭐ 34 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-11 - OSS – OopsSec Store: An intentionally vulnerable e-commerce application built with Next.js and React for web security training and CTF practice.
...
* <https://github.com/rubysec/bundler-audit> ⭐ 2,758 | 🐛 49 | 🌐 Ruby | 📅 2026-07-31 - Patch-level verification for Bundler
* <https://github.com/rubysec/ruby-advisory-db> ⭐ 1,070 | 🐛 11 | 🌐 Ruby | 📅 2026-08-12 - A database of vulnerable Ruby Gems
...
* <https://github.com/hakirisec/hakiri_toolbelt> ⭐ 276 | 🐛 7 | 🌐 Ruby | 📅 2017-05-19 - Hakiri Toolbelt is a command line interface for the Hakiri platform.
