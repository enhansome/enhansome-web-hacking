...
* <https://github.com/sqlmapproject/sqlmap> ⭐ 38,236 | 🐛 32 | 🌐 Python | 📅 2026-08-18 - Automatic SQL injection and database takeover tool

* <https://github.com/trustedsec/social-engineer-toolkit> ⭐ 15,219 | 🐛 12 | 🌐 Python | 📅 2026-06-04 - The Social-Engineer Toolkit (SET) repository from TrustedSec

* <https://github.com/owasp-amass/amass> ⭐ 15,009 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - domain recon

* <https://github.com/future-architect/vuls> ⭐ 12,234 | 🐛 90 | 🌐 Go | 📅 2026-08-19 Vulnerability scanner for Linux, agentless, written in golang.

* <https://github.com/beefproject/beef> ⭐ 10,979 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-21 - The Browser Exploitation Framework Project

* <https://github.com/sullo/nikto> ⭐ 10,673 | 🐛 1 | 🌐 Perl | 📅 2026-08-18 - Nikto web server scanner

* <https://github.com/wpscanteam/wpscan> ⭐ 9,735 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a black box WordPress vulnerability scanner

* <https://github.com/urbanadventurer/WhatWeb> ⭐ 6,792 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 WhatWeb - Next generation web scanner

* <https://github.com/commixproject/commix> ⭐ 5,821 | 🐛 4 | 🌐 Python | 📅 2026-08-21 Automated All-in-One OS command injection and exploitation tool

* <https://github.com/assetnote/kiterunner> ⭐ 3,242 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - API discovery

* <https://github.com/joaomatosf/jexboss> ⭐ 2,518 | 🐛 28 | 🌐 Python | 📅 2020-01-21 JBoss (and others Java Deserialization Vulnerabilities) verify and EXploitation Tool

* <https://github.com/nil0x42/phpsploit> ⭐ 2,490 | 🐛 27 | 🌐 Python | 📅 2024-05-06 PhpSploit - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
...
* <https://github.com/vigolium/vigolium> ⭐ 1,040 | 🐛 6 | 🌐 Go | 📅 2026-08-19 - High-fidelity web & API vulnerability scanner fusing agentic AI with a fast native engine; 250+ detection modules covering the OWASP Top 10, authenticated IDOR/BOLA & out-of-band testing, and OpenAPI/Postman/Burp/cURL inputs. Open-source, AGPL-3.0.

* <https://github.com/ASCIT31/Dark-Moon> ⭐ 856 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Darkmoon is an open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and keeps a per-finding evidence trail.

* <https://github.com/momenbasel/keyFinder> ⭐ 698 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively scans web pages for leaked API keys, tokens, and secrets using 80+ detection patterns and Shannon entropy across 10 attack surfaces.

* <https://github.com/lalithr95/fuzzapi> ⚠️ Archived Fuzzapi is a tool used for REST API pentesting

* <https://github.com/BlessedRebuS/Krawl> ⭐ 641 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Cloud-native Web deception server and anti-crawler.
...
* [BadUSB Script To Exfiltrate Passwords](https://github.com/MarkCyber/BadUSB/blob/main/HackStuff/CredentialHarvester.txt) ⭐ 367 | 🐛 2 | 🌐 Python | 📅 2025-03-20 - Extracts all saved passwords from Chrome, Firefox, and Edge to be saved onto secondary USB for further analysis.
...
* <https://github.com/DenisPodgurskii/pentestkit> ⭐ 233 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-19 - Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* <https://github.com/bad-antics/nullsec-linux> ⭐ 80 | 🐛 2 | 🌐 Shell | 📅 2026-04-17 - NullSec Linux - Security distribution with pre-configured web application testing tools
...
* <https://www.deepinfo.com/> - Deepinfo Attack Surface Platform discovers all your digital assets, monitors them 24/7, detects any issues, and notifies you quickly so you can take immediate action.
  * <https://github.com/bountyyfi/lonkero> ⭐ 1,042 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
- [ARS3NAL](https://github.com/inflictx/Arsenal) ⭐ 169 | 🐛 4 | 🌐 CSS | 📅 2026-07-09 - Offline-first, searchable arsenal: \~1500 payloads, command generator, GTFOBins, wordlists, embedded CyberChef, reverse shells and 70 checklists.
...
* `docker pull rustscan/rustscan:2.0.0` - [The Modern Port Scanner](https://github.com/RustScan/RustScan) ⭐ 20,303 | 🐛 60 | 🌐 Rust | 📅 2026-07-29
* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,656 | 🐛 855 | 🌐 Java | 📅 2026-08-21
...
* <https://github.com/Audi-1/sqli-labs> ⭐ 5,833 | 🐛 33 | 🌐 PHP | 📅 2023-12-11 - SQLI labs to test error based, Blind boolean based, Time based.
* <https://github.com/RhinoSecurityLabs/cloudgoat> ⭐ 3,702 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool
* <https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application> ⭐ 1,704 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-24
...
* <https://github.com/momenbasel/htb-writeups> ⭐ 222 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - HTB Writeups: The most comprehensive Hack The Box writeup collection with 500+ machines, 400+ challenges, ProLabs, Sherlocks, CTF events, and cheatsheets.
* <https://github.com/oliverwiegers/pentest_lab> ⭐ 219 | 🐛 0 | 🌐 Shell | 📅 2025-06-17 - Local pentest lab leveraging docker compose.
* <https://github.com/kOaDT/oss-oopssec-store> ⭐ 40 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - OSS – OopsSec Store: An intentionally vulnerable e-commerce application built with Next.js and React for web security training and CTF practice.
...
* <https://github.com/rubysec/bundler-audit> ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-08-15 - Patch-level verification for Bundler
* <https://github.com/rubysec/ruby-advisory-db> ⭐ 1,070 | 🐛 8 | 🌐 Ruby | 📅 2026-08-19 - A database of vulnerable Ruby Gems
